...
const MenuPrincipal: React.FC = () => {
  ...
  return (
    <div className="relative font-navidad">
      {/* Menú principal */}
        ...
        <div className="lg:hidden flex items-center justify-between ">
          <div className="flex items-center">
            {isMobileMenuOpen ? (
              ...
              <span className="mr-2  text-[#FFFFFFFF] text-xl">Menú</span>
            )}
            ...
            {menuItems.map((item) => (
              <div key={item.name}>
                <div className="flex justify-between items-center">
                  <Link
                    href={item.href || "#"}
                    className={`cursor-pointer text-[#687E57] text-2xl leading-[180%]  focus:border-b-[1px] focus:border-[#0a0a0c] ${
                      ...
                      <div key={subItem.name}>
                        <div className="flex justify-between items-center cursor-pointer">
                          <Link
                            ...
                            onClick={() =>
                              handleMobileSubItemClick(subItem.name)
                            }
                          >
                            {subItem.name}
                          </Link>
